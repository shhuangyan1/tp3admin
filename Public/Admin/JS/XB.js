$.XB = {
    ...
    searchtree: function (options) {
       ...
       //datagrid封装处理函数  拒绝记录
//  datagriddd: function (options) {
//  	
//      var settings = {
//          "datalist": "#DataListjudada",
//          "url": "DataListjudada",
//          "u":"",
//          "pagesize": 20,
//          "frozenColumns": [],
...
//  },
//  终审记录
//   datagridzhongshen: function (options) {
//   	
//      var settings = {
//          "datalist": "#DataListzhongshen",
//          "url": "DataListzhongshen",
//          "u":"",
//          "pagesize": 20,
//          "frozenColumns": [],
//          "columns": [],
...
var Common = {
    ...
    AuditFormatter: function (value, rec, index) {
        if(value=="3"){
            ...
            return "<span style='color:orange;'>申请提交</span>";
        }else if(value=="1"){
    ...
    SomeFormatter: function (value, rec, index) {
        return value == "是" ? "<span style='color:red;'>是</span>" : value;
    },
