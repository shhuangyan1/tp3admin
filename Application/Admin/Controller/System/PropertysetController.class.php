...
namespace Admin\Controller\System;
 use XBCommon;
 class PropertysetController extends BaseController{

     const T_TABLE='sys_propertyset';
     const T_PARAM='sys_propertyparam';
     ...
     public function Del(){
         ...
         //判断下面是否有属性
         $count=M(self::T_PARAM)->where(array('PropertyID'=>array('in',$idArr),'IsDel'=>0))->count();
         if($count>0){
             $this->ajaxReturn(0,"下面有属性参数，无法删除");
         }
