     ...
     public function detail(){
        ...
        if($ID){
            $infos=M('renzen_memberinfo')->alias('a')
                   ->field('a.ID,a.UserID,a.InCome,a.Education,a.ZhiYe,a.Status,a.JAddress,a.JZTime,a.CompanyName,a.CompanyAddress,a.CompanyMobile,b.Mobile,b.TrueName,b.NickName,b.Sex')
                   ->join('left join xb_mem_info b on a.UserID=b.ID')
                   ->where(array('a.ID'=>$ID))->find();
            $this->assign('infos',$infos);
        }
        $this->display('Renzen/Memberinfo/Detail');
     }
     //审核
