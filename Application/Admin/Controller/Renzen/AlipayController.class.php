 ...
 */
 ...
 class AlipayController extends BaseController{
     ...
     public function DataList(){
         ...
         $where['IsDel']=0;
         //查询的数据表字段名
         $col='ID,UserID,Email,Balance,HuabeiLimit,HuabeiRet,HuabeiBalance,TaobaoName,RenzTime,Status';//默认全字段查询
